...
@NamedQueries({
    ...
    , @NamedQuery(name = "Unidades.findByAbreviado", query = "SELECT u FROM Unidades u WHERE u.abreviado = :abreviado")})
public class Unidades implements Serializable {
    ...
    public Unidades(Integer id, String nombre, String abreviado) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "sv.get.Entidades.Unidades[ id=" + id + " ]";
    }
